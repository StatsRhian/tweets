...
def url(item):
    return "https://twitter.com/statsrhian/status/" + item["id_str"]
...
<head>
  ...
  <title>Rhian's twitter archive</title>
...
<body>
  <div class="wrapper" id="app">
    <h1><a href="../../..">RHian's twitter archive</a></h1>
    <a id="source" href="https://github.com/statsrhian/tweets-archive"> <img alt="source code" src="../../../github-mark.png">  </a>
          ...
          <div><div class="tweet-header">
              ...
              <div class="tweet-name-row">
                <div class="fullname-and-username">
                  <a class="fullname" href="/" title="Rhian Davies">Rhian Davies</a>
                  <a class="username" href="/" title="@statsrhian">@statsrhian</a>
                </div>
...
def main():
    data = read_data()
    for item in data:
        os.makedirs(f"statsrhian/status/{item['id_str']}", exist_ok=True)
        with open(f"./statsrhian/status/{item['id_str']}/index.html", "w") as f:
